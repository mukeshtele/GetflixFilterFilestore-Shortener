...
API_ID = int(environ.get('API_ID', '22679524'))
API_HASH = environ.get('API_HASH', '2aaeb0aaf56dfc49d694fa4f7ed7db1c')
BOT_TOKEN = environ.get('BOT_TOKEN', "6157918517:AAE7LolcUnN_yuuLour7si1_GaXAzQFiJoE")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1169821005').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mukeshtele01:password01@cluster0.2fzcsos.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "GetFlixFilter")
...
DOWNLOAD_TEXT_URL = "https://t.me/central_tutorial/6"
